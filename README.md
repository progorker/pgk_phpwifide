...
==============================
[ myWifide ] IDE @ Wi-Fi Network for PHP
==============================
...
phpWifide is simple IDE for PHP. It is designed
to work on Wi-Fi network or single user hosting.

phpWifide is ready to use on Testor Gifts such as:

+ Testor Cloud Personal Gift: https://progorker.github.io/sponsor/testor.cloud.personal.html
  o It is not supported to execute fully PHP script on-site. It is supported to execute fully PHP script on local machine.

+ Testor Cloud Startup Gift: https://progorker.github.io/sponsor/testor.cloud.startup.html
  o It is supported to execute fully PHP script both on-site and on local machine
...
+ All commands of phpTestor is supported ( https://progorker.github.io/phptestor_api/ )
...
![](https://github.com/progorker/pgk_phpwifide/blob/main/phpWifide/shots/shot_001.png?raw=true)

![](https://github.com/progorker/pgk_phpwifide/blob/main/phpWifide/shots/shot_002.png?raw=true)
...
+ Tap on following images to view videos
```
